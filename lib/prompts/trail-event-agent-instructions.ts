...
- **race.name**: use the explicit race, distance, or modality name from the markdown when present. Short names and acronyms are valid. If no race-level name is stated, use \`null\`; do not invent one from the event name or distance.

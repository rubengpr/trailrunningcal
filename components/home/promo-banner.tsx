...
export function PromoBanner({ alt, className = '' }: PromoBannerProps) {
  return (
...
export function PromoTextStrip({ message, code }: PromoTextStripProps) {
  return (
    <aside className="w-full border-b border-[#000000] bg-[#00CB7B] px-3 py-2 text-center">

drop function public.get_admin_events_page(integer, integer, text, text, text);

create function public.get_admin_events_page(
  p_limit integer,
  p_offset integer,
...
declare
  ...
  v_province text := nullif(btrim(p_province), '');
begin

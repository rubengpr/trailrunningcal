      ...
      <div className="relative h-full flex flex-col justify-end p-6 sm:p-8 lg:p-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
          ...
          <div className="text-white">
            <h3
              className={`${montserratExtrabold.className} text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-white mb-2`}
            >
              {raceName}
            </h3>
            <p
              className={`${montserratMedium.className} text-md sm:text-lg lg:text-xl`}
            >
